            ...
            if ($daySchedules->isNotEmpty()) {
                ...
                foreach ($daySchedules->sortBy('hour.start_time') as $schedule) {
                    ...
                    if (
                        ...
                        $currentGroup['end_time'] = $schedule->hour->end_time ? $schedule->hour->end_time->format('H:i:s') : $currentGroup['end_time'];

                        // Tambahkan waktu individual untuk setiap jam
                        $currentGroup['hour_times'][$schedule->hour->slot_number] = $schedule->hour->start_time ? $schedule->hour->start_time->format('H:i:s') : null;
                        $currentGroup['hour_end_times'][$schedule->hour->slot_number] = $schedule->hour->end_time ? $schedule->hour->end_time->format('H:i:s') : null;
                        ...
                        $currentGroup = [
                            ...
                            'start_time' => $schedule->hour->start_time ? $schedule->hour->start_time->format('H:i:s') : null,
                            'end_time' => $schedule->hour->end_time ? $schedule->hour->end_time->format('H:i:s') : null,
                            // Tambahkan array untuk menyimpan waktu individual setiap jam
                            'hour_times' => [
                                $schedule->hour->slot_number => $schedule->hour->start_time ? $schedule->hour->start_time->format('H:i:s') : null
                            ],
                            'hour_end_times' => [
                                $schedule->hour->slot_number => $schedule->hour->end_time ? $schedule->hour->end_time->format('H:i:s') : null
                            ],
                            'hour_schedules' => [
