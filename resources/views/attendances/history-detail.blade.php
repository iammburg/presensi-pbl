                    ...
                    <div class="card p-3 mb-4" style="border: #0e3b7c 1px solid;">
                        <form class="row gx-2 gy-2 align-items-center" method="GET" action="">
                            ...
                            <div class="col-auto d-flex align-items-center">
                                ...
                                <label for="tanggal" class="form-label mb-1 me-2 mr-2">Tanggal: </label>
                                <select class="form-select select2" id="tanggal" name="tanggal" style="min-width: 200px;"
                            ...
                            <tbody>
                                @foreach ($students as $i => $student)
                                    @php
                                        ...
                                        $waktu = $att
                                            ? ($att->time_in
                                                ? date('H:i:s', strtotime($att->time_in))
                                                : '-')
                                            : '-';
                                        $badgeClass =
                                            $status === 'Hadir'
