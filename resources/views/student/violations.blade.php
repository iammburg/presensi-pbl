...
<div class="container-fluid py-4 px-5">
    <div class="row mb-3 align-items-center">
        <div class="col-md-8">
            <h3 class="fw-bold mb-2">POIN PELANGGARAN</h3>
        </div>
    </div>
    ...
    <div class="card card-primary card-outline shadow-sm">
        <div class="card-header bg-tertiary text-white d-flex align-items-center justify-content-between" style="border-radius: 0.5rem 0.5rem 0 0;">
            <span class="card-title m-0 flex-grow-1 fw-bold">Rekap Data Pelanggaran - {{ $student->name }}</span>
            <span class="btn btn-info fw-bold px-4 py-2 mb-0" style="font-size: 1.1rem;">TOTAL POIN : {{ $totalPoint }}</span>
        </div>
        <div class="card-body p-4">
            <div class="table-responsive">
                <table id="violationsTable" class="table table-bordered table-hover mb-0">
...
@push('css')
    ...
    <style>
        ...
        #violationsTable td, #violationsTable th {
            font-size: 15px;
        }
