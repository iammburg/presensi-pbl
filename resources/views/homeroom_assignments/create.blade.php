        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 text-uppercase">
                    <h4 class="m-0">Tambah Data Wali Kelas</h4>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('manage-homeroom-assignments.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                @if(session('error'))
                                ...
                                @if(count($academicYears) == 0)
                                    <div class="alert alert-warning mt-3">
                                        <i class="fas fa-exclamation-triangle"></i> Tidak ada data tahun akademik yang tersedia. 
                                        Tambahkan data tahun akademik terlebih dahulu.
                                    </div>
                                @endif
                            </div>
