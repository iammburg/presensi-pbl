...
$(function () {
                    ...
                    return `
                        <div class="dropdown">
                            <button class="d-flex align-items-center justify-content-center bg-white border border-primary rounded shadow-sm"
                                style="width: 60px; height: 30px; padding: 0;" type="button" id="actionMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    $('#importExcelForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '{{ route('manage-students.import') }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            error: function (xhr) {
                let msg = xhr.responseJSON?.message || 'Gagal mengimpor file.';
    ...
    $('#studentsTable').on('click', '.student-detail-link', function(e) {
        ...
        $.ajax({
            url: `/manage-students/${nisn}/detail`,
            method: 'GET',
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <table class="table table-sm">
                                ...
                                <tr><th>Kelas</th><td>${data.class_name ?? '-'}</td></tr>
                            </table>
                        </div>
                    </div>
                `);
