                    ...
                    <form action="{{ route('manage-students.update', $student->nisn) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date" value="{{ old('birth_date', $student->birth_date) }}">
                                @error('birth_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('parent_email') is-invalid @enderror" id="parent_email" name="parent_email" value="{{ old('parent_email', $student->parent_email) }}">
                                @error('parent_email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('enter_year') is-invalid @enderror" id="enter_year" name="enter_year" value="{{ old('enter_year', $student->enter_year) }}">
                                @error('enter_year')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                @if($student->photo)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/'.$student->photo) }}" alt="Foto Siswa" class="img-thumbnail" style="max-height: 200px">
                                </div>
                                @endif
                            </div>
                        </div>
