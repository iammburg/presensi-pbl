                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="session_type" class="form-control @error('session_type') is-invalid @enderror" required>
                                    <option value="Jam pelajaran" {{ old('session_type', $hour->session_type) == 'Jam pelajaran' ? 'selected' : '' }}>Jam Pelajaran</option>
                                    <option value="Jam istirahat"  {{ old('session_type', $hour->session_type) == 'Jam istirahat'  ? 'selected' : '' }}>Jam Istirahat</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="slot_number" class="form-control @error('slot_number') is-invalid @enderror" required>
                                    ...
                                    @for ($i = 1; $i <= 15; $i++)
                                        <option value="{{ $i }}" {{ old('slot_number', $hour->slot_number) == $i ? 'selected' : '' }}>
                                            Jam ke-{{ $i }}
                                        </option>
                                    @endfor
                                </select>
                            ...
                            <div class="form-group form-check">
                                <input type="checkbox"
                                       ...
                                       id="chkFridayEdit"
                                       {{ old('is_friday', $hour->is_friday) ? 'checked' : '' }}>
