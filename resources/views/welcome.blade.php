            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <a class="navbar-brand w-auto" href="index.html">
                    ...
                    <!-- logo dark--><img class="logo dark img-fluid"
                        src="{{ asset('landing-page/assets/images/logo-dark.svg') }}"
                        alt="FreeBootstrap.net image placeholder">

                    <!-- logo light--><img class="logo light img-fluid"
                        src="{{ asset('landing-page/assets/images/logo-light.svg') }}"
                        alt="FreeBootstrap.net image placeholder">
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up"
                                    ...
                                    <div class="logos mb-4" data-aos="fade-up" data-aos-delay="400"><span
                                        ...
                                        <div class="logos-images d-flex gap-4 align-items-center"><img
                                                ...
                                                src="{{ asset('landing-page/assets/images/logo/actual-size/logo-air-bnb__black.svg') }}"
                                                alt="Company 1" style="width: 110px;"><img
                                                class="img-fluid js-img-to-inline-svg"
                                                src="{{ asset('landing-page/assets/images/logo/actual-size/logo-ibm__black.svg') }}"
                                                alt="Company 2" style="width: 80px;"><img
                                                class="img-fluid js-img-to-inline-svg"
                                                src="{{ asset('landing-page/assets/images/logo/actual-size/logo-google__black.svg') }}"
                        ...
                        <div class="col-lg-6">
                            <div class="hero-img"><img class="img-card img-fluid"
                                    src="{{ asset('landing-page/assets/images/card-expenses.png') }}"
                                    alt="Image card" data-aos="fade-down" data-aos-delay="600"><img
                                    class="img-main img-fluid rounded-4"
                                    src="{{ asset('landing-page/assets/images/hero-img-1-min.jpg') }}"
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3"
                                    ...
                                    <ul class="d-flex flex-row flex-wrap list-unstyled gap-3 features"
                                        ...
                                        <li class="d-flex align-items-center gap-2"><span
                                                class="icon rounded-circle text-center"><i
                                                    class="bi bi-check"></i></span><span
                                                class="text">Empowerment</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="img-wrap position-relative"><img class="img-fluid rounded-4"
                                    src="{{ asset('landing-page/assets/images/about_2-min.jpg') }}"
                                            ...
                                            <div class="col-lg-11">
                                                <div class="h-100 flex-column justify-content-between d-flex">
                                                    <div>
                                                        ...
                                                        <p class="mb-5">Experience the future of finance with our
                                                            secure, efficient, and user-friendly financial services. Our
                                                            cutting-edge platform ensures your transactions are safe,
                                                            streamlined, and easy to manage, empowering you to take
                                                            control of your financial journey with confidence and
                                                            convenience."</p>
                                                    </div>
                                            ...
                                            <div class="col-lg-11">
                                                <div class="row">
                                                    <div class="col-sm-6" data-aos="fade-up" data-aos-delay="0">
                                                        ...
                                                        <p>Easy navigation with responsive design for various devices.
                                                        </p>
                                                    </div>
                                                    <div class="col-sm-6" data-aos="fade-up" data-aos-delay="100">
                                                        ...
                                                        <p>Budget tracking, expense categorization, and personalized
                                                            insights.</p>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6" data-aos="fade-up" data-aos-delay="300">
                                                        ...
                                                        <p>Data encryption, fraud detection, and prevention mechanisms.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative"
                                ...
                                <div data-aos="fade-right" data-aos-delay="500"><img class="arch-line"
                                        src="{{ asset('landing-page/assets/images/arch-line.svg') }}"
                                        alt="FreeBootstrap.net image placeholder">
                                </div><span
                        ...
                        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                            <div
                                ...
                                <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse"
                                        src="{{ asset('landing-page/assets/images/arch-line-reverse.svg') }}"
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <p class="mb-4">User-friendly platforms that allow individuals to invest in
                                        stocks, bonds, and other assets with minimal barriers, making investment
                                        accessible to all.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <p class="mb-4">Services that facilitate the buying, selling, and trading of
                                        cryptocurrencies, offering users a gateway to the digital currency market.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                                            class="icon-1 bi bi-arrow-right-short"></i><i
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <p class="mb-4">Innovative insurance services that leverage technology to offer
                                        personalized policies, faster claims processing, and enhanced customer
                                        experiences.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                    ...
                    <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
                            ...
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="{{ asset('landing-page/assets/images/person-sq-2-min.jpg') }}"
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="testimonial rounded-4 p-4">
                                ...
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="{{ asset('landing-page/assets/images/person-sq-1-min.jpg') }}"
                                            alt="FreeBootstrap.net image placeholder"></div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    The investment options and portfolio management tools on this platform are
                                    top-notch. The variety of choices caters to all types of investors, from
                                    conservative to aggressive. I especially appreciate how the tailored recommendations
                                    align perfectly with my financial goals. It’s a game-changer for anyone serious
                                    about growing their wealth.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="{{ asset('landing-page/assets/images/person-sq-5-min.jpg') }}"
                                            alt="FreeBootstrap.net image placeholder"></div>
                                    <div class="lh-base"><strong class="d-block">Michael
                                            Rodriguez</strong><span>Investor</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    I never thought managing money could be this simple! The user-friendly interface and
                                    secure transaction process give me the confidence to handle my finances
                                    independently.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="{{ asset('landing-page/assets/images/person-sq-3-min.jpg') }}"
                                            alt="FreeBootstrap.net image placeholder"></div>
                                    <div class="lh-base"><strong class="d-block">Sarah Lee</strong><span>College
                                            Student</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    The security features are outstanding. Knowing that my financial data is protected
                                    gives me peace of mind, and the platform's efficiency makes it a pleasure to use.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="{{ asset('landing-page/assets/images/person-sq-7-min.jpg') }}"
                                            alt="FreeBootstrap.net image placeholder"></div>
                                    <div class="lh-base"><strong class="d-block">James Kim</strong><span>IT
                                            Consultant</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div class="testimonial rounded-4 p-4">
                                <blockquote class="mb-3">
                                    &ldquo;
                                    The platform’s intuitive design and robust features have been a game-changer for my
                                    startup. It’s helped me streamline operations and focus on growing my business.
                                    &rdquo;
                                </blockquote>
                                <div class="testimonial-author d-flex gap-3 align-items-center">
                                    <div class="author-img"><img class="rounded-circle img-fluid"
                                            src="{{ asset('landing-page/assets/images/person-sq-8-min.jpg') }}"
                                            alt="FreeBootstrap.net image placeholder"></div>
                                    <div class="lh-base"><strong class="d-block">Laura
                                            Brown</strong><span>Entrepreneur</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-controls="panelsStayOpen-collapseThree"> How long does it take to
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-controls="panelsStayOpen-collapseFour"> Will my website be
