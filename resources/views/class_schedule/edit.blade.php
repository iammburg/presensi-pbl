            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('manage-schedules.update', $schedule->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                @if(session('error'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="teacher_id" class="form-control @error('teacher_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($teachers as $teacher)
                                            <option value="{{ $teacher->nip }}" {{ (old('teacher_id') ?? $schedule->teacher_id) == $teacher->nip ? 'selected' : '' }}>
                                                {{ $teacher->name }}
                                            </option>
                                        @endforeach
                                    </select>
