            ...
            <div class="card-body p-0">
                ...
                @else
                    <div class="table-responsive">
                        <table class="table table-striped table-hover mb-0 table-bordered" style="font-family: 'Poppins', sans-serif;">
                            <thead style="background-color: #f8f9fa;">
                                <tr>
                                    <th class="text-center align-middle" style="width: 8%; padding: 12px 8px; border: 1px solid #dee2e6;">No</th>
                                    <th class="text-center align-middle" style="width: 18%; padding: 12px 15px; border: 1px solid #dee2e6;">Tipe Sesi</th>
                                    <th class="text-center align-middle" style="width: 15%; padding: 12px 15px; border: 1px solid #dee2e6;">Jam</th>
                                    <th class="text-center align-middle" style="width: 18%; padding: 12px 15px; border: 1px solid #dee2e6;">Waktu</th>
                                    <th class="text-center align-middle" style="width: 41%; padding: 12px 20px; border: 1px solid #dee2e6;">Mata Pelajaran & Guru</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @foreach($schedulesPerDay[$day] as $item)
                                    @if($item['start_hour_slot'] == $item['end_hour_slot'])
                                        {{-- Single hour slot --}}
                                        <tr>
                                            <td class="text-center align-middle fw-semibold" style="padding: 15px 8px; border: 1px solid #dee2e6;">
                                                {{ $rowNumber++ }}
                                            </td>
                                            ...
                                            <td class="text-center align-middle text-black" style="padding: 15px 15px; border: 1px solid #dee2e6; font-family: 'Poppins', sans-serif;">
                                                @if($item['session_type'] == 'Jam Istirahat')
                                                    <span class="text-muted">-</span>
                                                @else
                                                    <span class="fw-bold text-black" style="font-family: 'Poppins', sans-serif;">Jam ke-{{ $item['start_hour_slot'] }}</span>
                                                @endif
                                            </td>
                                            <td class="text-center align-middle text-muted" style="padding: 15px 15px; white-space: nowrap; font-family: 'Poppins', sans-serif; border: 1px solid #dee2e6;">
                                            ...
                                            @else
                                                <div>
                                                    <div class="fw-bold text-dark mb-1" style="font-size: 15px; font-family: 'Poppins', sans-serif;">
                                                        {{ $item['subject_name'] ?? 'N/A' }}
                                                    </div>
                                                    <div class="text-muted" style="font-size: 13px; font-family: 'Poppins', sans-serif;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle text-black" style="padding: 15px 15px; border: 1px solid #dee2e6; font-family: 'Poppins', sans-serif;">
                                                    @if($item['session_type'] == 'Jam Istirahat')
                                                        <span class="text-muted">-</span>
                                                    @else
                                                        <span class="fw-bold text-black" style="font-family: 'Poppins', sans-serif;">Jam ke-{{ $hour }}</span>
                                                    @endif
                                                </td>
                                                <td class="text-center align-middle text-muted" style="padding: 15px 15px; white-space: nowrap; font-family: 'Poppins', sans-serif; border: 1px solid #dee2e6;">
                                                    @php
                                                ...
                                                @else
                                                    <div>
                                                        <div class="text-dark mb-1" style="font-size: 15px; font-family: 'Poppins', sans-serif;">
                                                            {{ $item['subject_name'] ?? 'N/A' }}
                                                        </div>
                                                        <div class="text-muted" style="font-size: 13px; font-family: 'Poppins', sans-serif;">
